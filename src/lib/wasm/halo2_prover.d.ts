...
* @returns {boolean}
*/
export function wasm_verify_proof(_params: Uint8Array, proof: Uint8Array, circuit: number): boolean;
/**
* @returns {number}
*/
...
export interface InitOutput {
  ...
  readonly wasm_verify_proof: (a: number, b: number, c: number, d: number, e: number) => number;
